// To parse this data:
//
//   import { Convert, IPokeData } from "./file";
//
...
export class Convert {
    public static toIPokeData(json: string): IPokeData {
        return cast(JSON.parse(json), r("IPokeData"));
    }

    public static iPokeDataToJson(value: IPokeData): string {
        return JSON.stringify(uncast(value, r("IPokeData")), null, 2);
    }
}
